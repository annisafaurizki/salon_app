...
AddLayananModel addLayananModelFromJson(String str) => AddLayananModel.fromJson(json.decode(str));

String addLayananModelToJson(AddLayananModel data) => json.encode(data.toJson());
...
class AddLayananModel {
    ...
    factory AddLayananModel.fromJson(Map<String, dynamic> json) => AddLayananModel(
