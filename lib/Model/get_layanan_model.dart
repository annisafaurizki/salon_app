...
//
//     final listLayanan = listLayananFromJson(jsonString);

import 'dart:convert';

GetLayanan listLayananFromJson(String str) => GetLayanan.fromJson(json.decode(str));

String listLayananToJson(GetLayanan data) => json.encode(data.toJson());
